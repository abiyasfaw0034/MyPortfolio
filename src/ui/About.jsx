    ...
    <div id="about" className="bg-gray-900 text-white py-24 px-10">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <p className="text-lg leading-relaxed mb-6">
          Hi, I’m <span className="font-bold text-teal-400">Abiy Asfaw</span>, a
          passionate <span className="text-teal-400">Information Science</span>{" "}
          student at{" "}
        ...
        <p className="text-lg leading-relaxed mb-6">
          ...
          of balance. I enjoy immersing myself in the world of music and movies,
          which inspire my creativity and broaden my perspective. Playing
          basketball is another passion of mine—it keeps me active, helps me
          stay disciplined, and teaches the importance of teamwork.
        </p>
        <p className="text-lg leading-relaxed mb-6">
